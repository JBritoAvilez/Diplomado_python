# -*- coding: utf-8 -*-
"""
Created on Fri Jun 24 16:26:55 2022

@author: jonat
"""
# Se hacen las importaciones de las librerias que deseamos utilizar
...
# Librerias para los Gráficos

import matplotlib.pyplot as plt
from matplotlib import style
style.use('ggplot') or plt.style.use('ggplot')

# Librerias para el Preprocesado y modelado
...
#Es una función declarada para reutilizar código para trazar un dendrograma, 
#toma el modelo como parámetro y dentro de la función ejecuta un bucle for 
#para determinar el orden de los grupos.
...
# Simularemos unos datos a tras del siguiente metodo llamado make_blobs
...
# Mostraremos el grafico de los puntos a partir de las cordenadas X y Y 
...
# Implementaremos los 3 modelos con difrentes AgglomerativeClustering 
